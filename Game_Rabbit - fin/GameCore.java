...
public abstract class GameCore extends JFrame implements KeyListener {
    ...
    private boolean isRunning;			// true if the animation loop should continue
    ...
    private Window win;					// Window object used to handle display
     ...
     */
    public void init(boolean full, int xres, int yres) {
    ...
    public void gameLoop() {
        ...
        Graphics2D g;
        BufferStrategy bufferStrat = super.getBufferStrategy();
        isRunning = true;
        ...
        while (isRunning) {
	        ...
	        if (g != null)
	        {
	            ...
	            else
	            {
            	    ...
            	    if (bufferStrat != null) bufferStrat.show();
	            }
